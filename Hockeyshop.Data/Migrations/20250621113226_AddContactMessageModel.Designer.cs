...
namespace Hockeyshop.Data.Migrations
{
    ...
    [Migration("20250621113226_AddContactMessageModel")]
    partial class AddContactMessageModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.CMS.ContactEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.CMS.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.Cart.CartItem", b =>
                {
                    ...
                    b.Property<int?>("UserCartIdUserCart")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.Core.User", b =>
                {
                    ...
                    b.Property<int?>("UserRoleIdUserRole")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.Orders.Order", b =>
                {
                    ...
                    b.Property<int?>("OrderStatusIdOrderStatus")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrderStatusIdOrderStatus");
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.Products.Product", b =>
                {
                    ...
                    b.Property<int?>("ProductCategoryIdProductCategory")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductCategoryIdProductCategory");
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.Cart.CartItem", b =>
                {
                    ...
                    b.HasOne("Hockeyshop.Data.Data.Cart.UserCart", null)
                        .WithMany("CartItems")
                        .HasForeignKey("UserCartIdUserCart");
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.Core.User", b =>
                {
                    ...
                    b.HasOne("Hockeyshop.Data.Data.Core.UserRole", null)
                        .WithMany("Users")
                        .HasForeignKey("UserRoleIdUserRole");
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.Orders.Order", b =>
                {
                    ...
                    b.HasOne("Hockeyshop.Data.Data.Orders.OrderStatus", null)
                        .WithMany("Orders")
                        .HasForeignKey("OrderStatusIdOrderStatus");
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.Payments.Payment", b =>
                {
                    ...
                    b.HasOne("Hockeyshop.Data.Data.Payments.PaymentMethod", null)
                        .WithMany("Payments")
                        .HasForeignKey("PaymentMethodIdPaymentMethod");

                    b.HasOne("Hockeyshop.Data.Data.Payments.PaymentStatus", null)
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("Hockeyshop.Data.Data.Products.Product", b =>
                {
                    ...
                    b.HasOne("Hockeyshop.Data.Data.Products.ProductCategory", null)
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryIdProductCategory");

                    b.HasOne("Hockeyshop.Data.Data.Products.Supplier", null)
                        .WithMany("Products")
