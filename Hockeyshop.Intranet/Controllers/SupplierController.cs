...
namespace Hockeyshop.Intranet.Controllers
{
    public class SupplierController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdSupplier,Name,ContactEmail,Phone,Address,CreatedAt")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdSupplier,Name,ContactEmail,Phone,Address,CreatedAt")] Supplier supplier)
        {
