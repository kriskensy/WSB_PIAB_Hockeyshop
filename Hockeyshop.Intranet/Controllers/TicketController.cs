...
namespace Hockeyshop.Intranet.Controllers
{
    public class TicketController : Controller
    {
        ...
        {
            var hockeyshopIntranetContext = _context.Ticket.Include(t => t.User);
        ...
        public async Task<IActionResult> Create([Bind("IdTicket,Title,Description,Status,CreatedAt,ClosedAt,IdUser")] Ticket ticket)
        {
            ...
            ViewData["IdUser"] = new SelectList(_context.Set<User>(), "IdUser", "Email", ticket.IdUser);
            return View(ticket);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTicket,Title,Description,Status,CreatedAt,ClosedAt,IdUser")] Ticket ticket)
        {
